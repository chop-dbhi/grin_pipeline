...
```{r denovo_igv, warnings = FALSE, eval=showChunk, echo=FALSE, message=FALSE, cache=FALSE,fig.path='{{SLINK}}/'}
denovo$variant_id<-paste("<a href=\"",paste(paste("../screenshots",paste(familyname,'denovo',denovo$variant_id,'png',sep="."),sep="/")),"\">",denovo$variant_id,"</a>",sep="")
```
...
colnames(denovo)[grep('^chrom$|start|vcf_id', colnames(denovo))] <- c('chr','pos','rsid')
denovo$end <- NULL
