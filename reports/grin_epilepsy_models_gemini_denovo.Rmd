...
viewDataTable <- function(dat){
  ...
  cols2hide <- grep('Description|Variants|Perc|chr|^pos$|rsid|^ref$|^alt$|^gene$|
                    impact_severity|rvis_score|depths|gt_quals|family_genotypes|denovo_prob|is_exonic|is_splicing|functiongvs|exac_an_all',
...
denovo.sub <- denovo.sub[which(denovo.sub$exac_an_all == "None" | denovo.sub$exac_an_all == "0"),]
