...
```{r denovo_variants, echo=FALSE, message=FALSE, cache=FALSE,  fig.path='{{SLINK}}/'}
vrl<- filteredVariants(denovo)
...
```{r varfiltsetup, echo=FALSE, message=FALSE, cache=FALSE,  fig.path='{{SLINK}}/'}
...
```{r recurrent, echo=FALSE, message=FALSE, cache=FALSE,  fig.path='{{SLINK}}/'}
...
```{r literature, echo=FALSE, message=FALSE, cache=FALSE,  fig.path='{{SLINK}}/'}
...
```{r coding, echo=FALSE, message=FALSE, cache=FALSE,  fig.path='{{SLINK}}/'}
