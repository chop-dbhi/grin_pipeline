...
if(!exists("denovo"))  denovo <- get(load('../../GRCh38/analysis/Kiel_DFG_2015_Trio_3_E01181.trio.phased.com.filtered.ad.de.nm.snpeff.noask.denovo.RData'))
if(!exists("arhomo"))  arhomo <- get(load('../../GRCh38/analysis/Kiel_DFG_2015_Trio_3_E01181.trio.phased.com.filtered.ad.de.nm.snpeff.noask.arhomo.RData'))
    
if(!exists("ped")) ped <-read.table("../../GRCh38/analysis/Kiel_DFG_2015_Trio_3_E01181.pedfile",header=TRUE)
if(!exists("mytrio")) mytrio<-"Kiel_DFG_2015_Trio_3_E01181"
```
