...
if(!exists("denovo"))  denovo <- get(load('GRCh38/analysis/12MAE_E01020.denovo.RData'))
if(!exists("ped")) ped <-read.table("GRCh38/analysis/12MAE_E01020.pedfile",header=TRUE)
if(!exists("mytrio")) mytrio<-"12MAE_E01020"
```
